...
class BukusControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create buku" do
    assert_difference('Buku.count') do
      post bukus_url, params: { buku: { judul: @buku.judul, kota: @buku.kota, penerbit: @buku.penerbit, penulis: @buku.penulis, tahun: @buku.tahun } }
    end
  ...
  test "should update buku" do
    patch buku_url(@buku), params: { buku: { judul: @buku.judul, kota: @buku.kota, penerbit: @buku.penerbit, penulis: @buku.penulis, tahun: @buku.tahun } }
